...
| `Task_010C_Tokenizer_Model_and_Feasibility.md` | Tokenizer, model, loss, and original feasibility handoff | Historical provenance; amended feasibility portions are superseded as current authority by the accepted D2 path | Historical implementation/evidence-preparation contract, not result evidence | No current authority |
...
| `Task_010C_D3_Postmortem_Verifier.py.txt` | Frozen verifier/review aid for D3 | Historical provenance; not scientific authority | Verification provenance, not scientific evidence | None |
